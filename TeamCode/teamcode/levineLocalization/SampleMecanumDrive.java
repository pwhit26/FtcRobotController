...
import static org.firstinspires.ftc.teamcode.levineLocalization.DriveConstants.MAX_ACCEL;
import static org.firstinspires.ftc.teamcode.levineLocalization.DriveConstants.MAX_ANG_ACCEL;
import static org.firstinspires.ftc.teamcode.levineLocalization.DriveConstants.MAX_ANG_VEL;
import static org.firstinspires.ftc.teamcode.levineLocalization.DriveConstants.MAX_VEL;
...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.0167;
    ...
    public static double xError = 0.125;
...
//                RevHubOrientationOnRobot.UsbFacingDirection.UP));
        ...
        //List of motor rpms to make each motor the same

        double[] motorMaxRPMs = {1.0, 1.0, 1.0, 1.0};

        int i = 0;
        for (DcMotorEx motor : motors) {
            MotorConfigurationType motorConfigurationType = motor.getMotorType().clone();
            motorConfigurationType.setAchieveableMaxRPMFraction(motorMaxRPMs[i]);
